...
!(function (a, b) {
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        pe = "Janvier_Fevrier_Mars_Avril_Mai_Juin_Juillet_Août_Septembre_Octobre_Novembre_Decembre".split("_"),
        qe = "Jan_Fev_Mar_Avr_Mai_Juin_Juil_Aou_Sep_Oct_Nov_Dec".split("_"),
        re = be,
        se = be;
    U("Y", 0, 0, function () {
        var a = this.year();
